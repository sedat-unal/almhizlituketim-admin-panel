            ...
            <div class="content ">
                <div class="page-header d-md-flex justify-content-between">
                    ...
                    <div class="mt-3 mt-md-0">
                        ...
                        <a href="#" class="btn btn-primary ml-0 ml-md-2 mt-2 mt-md-0 dropdown-toggle"
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0"><a class="link-1" href="#">See visits</a> that had a higher than
                                            expected
                                            bounce rate.</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0"><a class="link-1" href="#">See referring</a> domains that sent
                                            most visits
                                            last month.</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0"><a class="link-1" href="#">See clients</a> that accepted your
                                            invitation to
                                            connect.</p>
                                    </div>
                                </div>
